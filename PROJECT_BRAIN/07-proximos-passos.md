...
- **Push para GitHub + import na Vercel** — o repositório Git local já existe com 1 commit (`marketing-hub/`), mas criar o repositório remoto e dar push exige a conta GitHub do usuário; e conectar na Vercel exige a conta dele lá também. Ver `06-deploy.md` para o passo a passo exato.
